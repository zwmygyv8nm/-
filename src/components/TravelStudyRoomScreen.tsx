  ...
  return (
    <div className="absolute left-5 z-20" style={{ top: "24%" }}>
      <div
        ...
        style={{ width: "clamp(140px,15vw,210px)", background: "rgba(255,253,248,0.93)", backdropFilter: "blur(8px)", fontFamily: "var(--font-klee), sans-serif", fontWeight: 700 }}
      >
        {/* マスキングテープ */}
        <div
  ...
  return (
    <div className="absolute right-5 z-20" style={{ top: "22%" }}>
      <div
        ...
        style={{ width: "clamp(150px,17vw,230px)", background: "rgba(255,253,248,0.93)", backdropFilter: "blur(8px)", fontFamily: "var(--font-klee), sans-serif", fontWeight: 700 }}
      >
