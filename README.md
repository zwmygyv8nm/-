...
| ホーム画面 | 録音画面 | 結果画面 |
|:---:|:---:|:---:|
| ![ホーム画面](public/screenshots/home.png) | ![録音画面](public/screenshots/recording.png) | ![結果画面](public/screenshots/result.png) |

---

## 開発背景

採点型の面接練習アプリや英語スピーキングアプリは、最初から「正解・不正解」「点数」「発音評価」を軸に設計されているものが多く、話すことに苦手意識がある人にとっては使う前から心理的ハードルが高いと感じていました。

そこで、**話の正しさではなく「声を出せたこと」を積み上げる**という逆転の設計でMVPを作りました。AI採点や音声認識はあえて初期実装に含めず、まず「録音しても怖くない」という安心感を体験してもらえる状態を優先しています。
